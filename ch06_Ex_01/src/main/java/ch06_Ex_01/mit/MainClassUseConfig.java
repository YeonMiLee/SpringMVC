package ch06_Ex_01.mit;


import org.springframework.context.annotation.AnnotationConfigApplicationContext;

import ch06_Ex_01.mit.configuration.MemberConfig1;
import ch06_Ex_01.mit.configuration.MemberConfig2;
import ch06_Ex_01.mit.configuration.MemberConfig3;
...
public class MainClassUseConfig {
    ...
    public static void main(String[] args) {
		 ...
		 * AnnotationConfigApplicationContext(MemberConfigImport.class);
		 */
        ...
        printMemberInformatinService.printMembersInfo();   // 리스트
