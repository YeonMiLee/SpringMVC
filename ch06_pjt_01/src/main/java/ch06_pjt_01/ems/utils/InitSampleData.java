...
public class InitSampleData {
	 ...
	 * private String[] sPws = {"96539","64875","15284","48765","28661"}; private
	 * String[] sNames = {"agatha","barbara","chris","doris","elva"}; private int[]
	 * sAges = {19,22,20,27,19 }; private char[] sGenders = {'M','W','W','M','M'};
	 * private String[] sMajors =
	 * {"English Literature","Korean Language and Literature",
	 * "French Language and aliterature","Philosophy","History"};
	 */
	
	//applicationContext 생성 후 bean으로 초기화
